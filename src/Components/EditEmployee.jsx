...
const EditEmployee = () => {
    ...
    return ( 
        <div>
            <Navbar/>
        <div className="emp_form border w-25 rounded m-auto p-3">
            ...
            <div className="name ps-3 pt-3">
                ...
                <div className="fileupload mt-3 ms-3">
                    <input className="form-control w-100" type="text" id="formFile"   placeholder="Place image link here" ref={image}/>
                </div>
