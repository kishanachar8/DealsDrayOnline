...
const CreateEmp = () => {
   ...
   let [mobile,setMobile] = useState('')
    ...
    return (
        <div className="empform border w-25 rounded m-auto mt-2 p-3">
            ...
            <form action="" onSubmit={handlesubmit} className=" text-justify">
               ...
               <div className="dropdown">
                <label htmlFor="" className="ms-3 mt-2">Course</label><br />
                    <select name="" id="" value="Course" className=" mt-2 bg-light w-75  ms-3 rounded btn btn-light dropdown-toggle" required ref={designation}  >
